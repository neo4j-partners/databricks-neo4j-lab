...
2. Expand **neo4j_ibm_catalog > lakehouse**.
...
After clicking **New Genie space**, the **Connect your data** dialog appears. Select All Catalogs ->  `neo4j_ibm_catalog`  -> `lakehouse` -> then select `sensor_readings`, `aircraft`, `sensors`, `systems`.
...
> **Tip:** If you don't see the table under **Recent**, click **All** or use the search bar to find `neo4j_ibm_catalog`.
