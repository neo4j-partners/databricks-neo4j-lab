...
CATALOG = os.getenv("WORKSHOP_CATALOG", "neo4j_workshop")
VOLUME_SCHEMA = os.getenv("WORKSHOP_VOLUME_SCHEMA", "workshop_data")
VOLUME_NAME = os.getenv("WORKSHOP_VOLUME_NAME", "csv")
