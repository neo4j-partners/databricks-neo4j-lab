"""Read-only verification of Lab 5 data in Neo4j.
...
Lab 5 data was loaded correctly without the destructive clear+reload of run_lab5_02.py.

Queries ported from verify_labs/src/verify_labs/lab5_queries.py.

Usage:
    ./upload.sh verify_lab5.py && ./submit.sh verify_lab5.py
"""
...
# ── Query definitions (from verify_labs lab5_queries.py) ──────────────────────
...
def main():
    parser = argparse.ArgumentParser(
        description="Lab 5 Read-Only Verification: 13 Cypher queries"
    )
    ...
    print("=" * 70)
    print("Lab 5 Read-Only Verification — 13 queries")
    print("=" * 70)
