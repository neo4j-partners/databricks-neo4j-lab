...
If your organizer has provided OneBlink credentials, use the SSO login process. Follow the Neo4j Aura SSO Login guide (`SSO_Neo4j_Aura_Signup.md` in the lab materials). This option uses pre-configured workshop accounts.

=== Option B: Free Trial Signup (For self-paced learning)

If you are completing this lab independently or your organizer has instructed you to create a free trial, follow the Neo4j Aura Free Trial Signup guide (`Aura_Free_Trial.md` in the lab materials). This option provides a 14-day free trial with an automatically created instance.
...
image::lab1-create-instance.png[Neo4j Aura Console showing Create instance button]

TIP: If you already have existing instances, click the **Create instance** button in the top-right corner of the Instances page.

image::lab1-create-instance-alt.png[Create instance button for existing instances]
...
image::lab1-instance-details.png[Create instance configuration page]
