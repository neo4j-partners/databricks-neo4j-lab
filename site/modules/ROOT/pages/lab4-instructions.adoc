...
**"SQL query failed"** -- Verify table names in Unity Catalog: `databricks-neo4j-lab.lakehouse`. Check column names match documentation. Ensure Genie space has access to all required tables. Test queries directly in SQL Editor first.
