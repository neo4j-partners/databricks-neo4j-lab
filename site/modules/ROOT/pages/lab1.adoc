...
Continue to xref:lab1-instructions.adoc[Lab 1 Instructions] to set up your Neo4j Aura database and practice Cypher basics, or proceed to xref:lab2.adoc[Lab 2: Databricks ETL to Neo4j].
