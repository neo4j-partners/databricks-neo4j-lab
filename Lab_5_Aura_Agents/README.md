...
|-----------|----------------|
| **Cypher Templates** | Aircraft Systems and Components, Aircraft Maintenance Events, Aircraft Flights and Delays |
| **Similarity Search** | Search Maintenance Documentation |
