...
> **Concepts**: `labels(n)` returns a list of labels on a node; `[0]` takes the first. Gives a census of the entire graph. Expected: ~40K Flights, ~15K Delays, ~1.7K Components, 924 MaintenanceEvents, 167 Removals, 100 Aircraft, 800 Sensors, 400 Systems, 40 Airports.
